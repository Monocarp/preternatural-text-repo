        ...
        with output:
            ...
            <div style="border: 2px solid {status_color}; padding: 15px; margin: 10px 0; border-radius: 5px;">
                ...
                <div style="background: #f5f5f5; padding: 10px; margin: 10px 0; border-radius: 3px;">
                    ...
                    <p><strong>Regions:</strong> {', '.join(info.get('locations', {}).get('regions', [])) or 'None'}</p>
                ...
                <div style="background: #e8f4f8; padding: 10px; margin: 10px 0; border-radius: 3px;">
                    <h4>👤 People & Context</h4>
                    <p><strong>People:</strong> {', '.join(info.get('topics', {}).get('raw_analysis', {}).get('people', [])) or 'None'}</p>
                    <p><strong>Functional Purpose:</strong> {', '.join(info.get('topics', {}).get('raw_analysis', {}).get('functional_purpose', [])) or 'None'}</p>
                </div>
