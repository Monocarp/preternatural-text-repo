                            ...
                            {categoryAssignment.suggestedCategories.length > 0 && (
                              <div className="mb-3">
                                <div className="flex items-center gap-1.5 mb-1.5">
                                  ...
                                  <span className="text-xs text-gray-400">Suggested Categories</span>
                                </div>
                                <div className="flex flex-wrap gap-1">
                                  {categoryAssignment.suggestedCategories.map((path, idx) => (
                                    <button
                                      ...
                                      onClick={(e) => {
                                        e.stopPropagation()
                                        categoryAssignment.assignToPath(path)
                                      }}
                                      disabled={categoryAssignment.assigning}
                                      className="px-2 py-1 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded text-xs text-gray-200 hover:from-yellow-500/20 hover:to-orange-500/20 disabled:opacity-50 transition-colors"
                                    >
                                      {path.join(' → ')}
                                    </button>
                                  ))}
