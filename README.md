...
tags:
  ...
  - haystack
  - gradio
short_description: Interactive dashboard for searching and curating supernatural stories from historical texts.
---
...
This repository hosts the backend data and frontend code for a scalable system designed to extract, index, search, and curate stories of supernatural phenomena (e.g., possessions, witch trials) from historical texts. Starting with books like *Christian Mysticism Vol IV* by Joseph Von Gorres and *Investigations Into Magic Volume 2*, the project aims to expand to 100+ texts.
...
This is a **beta version**—core functionality is implemented, but we're iterating on scalability, UI polish, and additional books. Contributions welcome!
...
- Process new DOCX texts via the batch script (Step 4) for incremental embedding.
...
- Built with assistance from Grok by xAI.
